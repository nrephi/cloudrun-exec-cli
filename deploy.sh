...
gcloud projects add-iam-policy-binding $PROJECT_ID --member=serviceAccount:$SERVICE_ACCOUNT@$PROJECT_ID.iam.gserviceaccount.com --role roles/cloudtasks.tasks.create
...
curl -H "Authorization: Bearer $(gcloud auth print-identity-token)" https://bash-qgaicxr67q-ew.a.run.app/tasks?params=accords,1,50-100,https%3A%2F%2Fbash-qgaicxr67q-ew.a.run.app%2Fclick,GET,accords.app
 --data-urlencode 'params=accords,1,50-100,https://bash-qgaicxr67q-ew.a.run.app/click,GET,accords.app,accords louanges'
 curl -H "Authorization: Bearer $(gcloud auth print-identity-token)" https://bash-qgaicxr67q-ew.a.run.app/tasks?params=accords%261%261-5%26https%3A%2F%2Fbash-qgaicxr67q-ew.a.run.app%2Fclick%26GET%26accords.app

# curl http://localhost:8080/node_to_zero


# create cloud cheduler
gcloud scheduler jobs create http click-accords-app --project=$PROJECT_ID --location=europe-west1 --schedule="*/20 * * * *" --uri=https://bash-qgaicxr67q-ew.a.run.app/click
